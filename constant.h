 ...
 * Of cuirse, not all my code is far from being optimized for the memory
 * but here I was aware of this, so I did like that */

const int tau(200);           /**< constant for the differential equation */
const int C(10);              /**< constant for the differential equation */
